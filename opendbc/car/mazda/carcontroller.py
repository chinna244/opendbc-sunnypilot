...
class CarController(CarControllerBase, IntelligentCruiseButtonManagementInterface):
  ...
  def update(self, CC, CC_SP, CS, now_nanos):
    ...
    # holding wheel cancel or TJA. Without this guard ICBM's interleaved frames (historically
    # with TJA_BUTTON=0) race the wheel's own CRZ_BTNS and can fabricate TJA edges.
    icbm_suppress = (CC.cruiseControl.cancel or CC.cruiseControl.resume or
                     CS.cancel_button == 1 or CS.tja_button == 1)
